...
function each(object, template$$1) {
  ...
  try {
    return babelTypes.spreadElement(template$$1.expression);
  } catch (e) {
    debugger;
  }
}
...
function fnJade(template$$1, options) {
  options || (options = {});
  return jade.render(template$$1, Object.assign({ compiler: ElementCreateCompiler, template: template$$1 }, options));
}
